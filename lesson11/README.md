...
Или при необходимости — через Ansible добавить отдельный плейбук/тег.

---

## Помощь и поддержка

Если у вас возникнут вопросы или нужна помощь с настройкой — обращайтесь.

---

## Лицензия

Укажите здесь лицензию вашего проекта, если нужно.

---

*Примечание:* Все конфигурации, скрипты и исходники должны находиться в репозитории на GitHub или другом Git-сервере.
